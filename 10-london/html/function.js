$(document).ready(function(){
  ...
  // 랜드마크
    ...
    $indicator.on('click',function(evt){
      ...
      if (matchMedia("screen and (max-width: 425px)").matches) {
        $('.sec6 .slides-container p').addClass('mo425p');
        $('.sec6 .slides-container p .month').addClass('mo425month');
        $('.sec6 .slides-container p a').addClass('mo425a')
        $('.sec6 .slides-container p a span').addClass('mo425span');
