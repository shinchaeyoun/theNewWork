...
function landmarkFn() {
    const wrapper = $('.tab-wrap'),
        ...
        line = tabMeun.append('<div class="line"></div>');
...
function parkFn() {
    const scr1 = $('#park > .park-content:nth-of-type(1) > .screen > #photo'),
        scr2 = $('#park > .park-content:nth-of-type(2) > .screen > #photo'),
        scr3 = $('#park > .park-content:nth-of-type(3) > .screen > #photo'),
        $thmbs1 = $('#park > .park-content:nth-of-type(1) .thmbs > li > img'),
        $thmbs2 = $('#park > .park-content:nth-of-type(2) .thmbs > li > img'),
        $thmbs3 = $('#park > .park-content:nth-of-type(3) .thmbs > li > img');

    const content = $('#park .park-content'),
        screen = content.find($('.screen #photo')),
        thmbs = content.find($('.thmbs > li > img'));
...
function fastivalFn() {
    ...
    const content = $('.slides > .slides-container > p');
    ...
    if (matchMedia('screen and (max-width: 320px)').matches) {
        ...
        indicator.on('click', function (evt) {
            ...
            indicator.eq(nowIndex).parent().addClass('on');
