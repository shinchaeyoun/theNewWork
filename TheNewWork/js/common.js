...
function onoffFn() {
    ...
    $onoff.on('click', function () {
        ...
        if ($onoffLi.hasClass('active')) {
            localStorage.setItem('saveType', 'on');
        } else {
            localStorage.setItem('saveType', 'off');
        };
    });

    if (localStorage.getItem('saveType') == 'on') {
        $onoffLi.addClass('active');
        $backGround.addClass('active');
        $red.addClass('active');
        $mainSubTit.addClass('active');
        $intTit.addClass('active');
        $intSubTit.addClass('active');
        $workTit.addClass('active');
        $topBg.addClass('active');
        $topLogo.addClass('active');
        $workMainTit.addClass('active');
        $workSpan.addClass('active');
        $likeTit.addClass('active');
        $travelTit.addClass('active');
        $travelTabTit.addClass('active');
        $flimArrow.addClass('active');
        $moviesTit.addClass('active');
        $musicTit.addClass('active');
        $booksTit.addClass('active');
        $companyName.addClass('active');
        $contactTit.addClass('active');
        $contactBtn.addClass('active');
        $contactSubTit.addClass('active');
        $contactThx.addClass('active');
        $footerRed.addClass('active');
        $footerSmallLogo.addClass('active');
    } else {
        $onoffLi.removeClass('active');
        $backGround.removeClass('active');
        $red.removeClass('active');
        $mainSubTit.removeClass('active');
        $intTit.removeClass('active');
        $intSubTit.removeClass('active');
        $workTit.removeClass('active');
        $topBg.removeClass('active');
        $topLogo.removeClass('active');
        $workMainTit.removeClass('active');
        $workSpan.removeClass('active');
        $likeTit.removeClass('active');
        $travelTit.removeClass('active');
        $travelTabTit.removeClass('active');
        $flimArrow.removeClass('active');
        $moviesTit.removeClass('active');
        $musicTit.removeClass('active');
        $booksTit.removeClass('active');
        $companyName.removeClass('active');
        $contactTit.removeClass('active');
        $contactBtn.removeClass('active');
        $contactSubTit.removeClass('active');
        $contactThx.removeClass('active');
        $footerRed.removeClass('active');
        $footerSmallLogo.removeClass('active');
    }
};
